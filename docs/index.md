...
**Getting Started:**
- [Query the Perovskite Database](notebooks/perla_notebooks/query-perovskite-database.ipynb) - Retrieve data from NOMAD
...
**Data Analysis:**
- [Architecture Evolution](notebooks/perla_notebooks/architecture-evolution.ipynb) - Device architecture trends over time
- [Bandgap Evolution](notebooks/perla_notebooks/bandgap-evolution.ipynb) - Bandgap distribution analysis
- [Performance Evolution](notebooks/perla_notebooks/performance-evolution.ipynb) - Track efficiency improvements

**Machine Learning:**
- [CrabNet Bandgap Prediction](notebooks/perla_notebooks/crabnet-perovskite-bandgap-prediction.ipynb) - ML-based property prediction
- [ML Distribution Shift Case Study](notebooks/perla_notebooks/ml-distribution-shift-case-study.ipynb) - Understanding data distribution challenges
