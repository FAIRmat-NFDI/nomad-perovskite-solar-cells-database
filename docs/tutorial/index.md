...
1. **[Sharing a Perovskite Composition](sharing_a_perovskite_composition.md)** - Learn the basics of working with perovskite compositions in NOMAD
...
After completing the tutorials, explore the [How-to guides](../how_to/install_this_plugin.md) for practical instructions on specific tasks, or dive into the [Reference documentation](../reference/composition_and_ion_schema.md) for detailed schema information.
