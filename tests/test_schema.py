...
def test_schema():
    ...
    assert entry_archive.results.material.topology[0].chemical_formula_iupac == "PbCNH6I3"
    assert entry_archive.results.material.topology[0].chemical_formula_hill == "CH6I3NPb"
    ...
    assert entry_archive.results.material.topology[1].structural_type == "molecule / cluster"
