...
PCBM-60 | LiF
        ...
        a_eln=dict(
            ...
            props=dict(suggestions=etl_enum_edit_quantity_suggestions),
        ),
    )
        ...
        a_eln=dict(
            ...
            props=dict(
                suggestions=[
                    ...
                    'Acetylacetone',
                    'Ni',
                    'Al(NO3)3\xa0· 9H2O; La(NO3)3\xa0· 6H2O',
                    'Ga',
                    'Pyridine | Undoped',
                    'Ag',
...
- If there are uncertainties, only state the best estimate, e.g. write 35 and not 20-50.
        ...
        a_eln=dict(
            component='EnumEditQuantity',
            props=dict(suggestions=['', '1.0', '0.25', '0.1', '0.16', '0.3']),
        ),
    )
...
Vacuum
        ...
        a_eln=dict(
            component='EnumEditQuantity',
            props=dict(suggestions=['Ar', 'N2', 'Unknown', 'Air']),
        ),
    )
...
- If there are uncertainties, only state the best estimate, e.g. write 35 and not 20-50.
        ...
        a_eln=dict(
            component='EnumEditQuantity',
            props=dict(suggestions=['', '40.0', '0.9', '30.0', '20.0']),
        ),
    )
